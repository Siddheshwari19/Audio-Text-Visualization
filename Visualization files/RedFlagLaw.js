document.addEventListener("DOMContentLoaded", function() {
    ...
    d3.json("RedFlagLaw_new.json").then( function(data) {
  ...
  .attr("fill", "#aaa");
    ...
    var link = svg
      ...
      var simulation = d3.forceSimulation(data.nodes)                 // Force algorithm is applied to data.nodes
          ...
          .force("charge", d3.forceManyBody().strength(-94))         // This adds repulsion between nodes. Play with the -400 for the repulsion strength
